...
import com.group_7.mhd.cooker.ViewHolder.OrderDetailAdapter;
...
public class OrderDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order_address.setText(Common.currentRequest.getAddresslat()+" , "+Common.currentRequest.getAddresslon());
