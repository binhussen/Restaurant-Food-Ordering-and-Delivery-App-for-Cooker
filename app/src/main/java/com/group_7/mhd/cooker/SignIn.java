                        ...
                        table_user.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            {*/
                                ...
                                if (dataSnapshot.child(phoneformat).exists()) {
                                    ...
                                    mDialog.dismiss();
                                    Chaf chaf = dataSnapshot.child(phoneformat).getValue(Chaf.class);
                                    chaf.setPhone(phoneformat);//set phone
                                    if (chaf.getPassword().equals(editPassword.getText().toString())) {

                                        Toast.makeText(SignIn.this, R.string.signeucc, Toast.LENGTH_SHORT).show();
                ...
                if (validatee()){
                    table_user.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            Chaf chaf = dataSnapshot.child(phoneformat).getValue(Chaf.class);
                            if (chaf.getSecureCode().equals(editSecureCode.getText().toString()))
                                Toast.makeText(SignIn.this, "Your Password : "+chaf.getPassword(),Toast.LENGTH_LONG).show();
                            else
